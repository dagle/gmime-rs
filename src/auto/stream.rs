...
impl<O: IsA<Stream>> StreamExt for O {
    ...
    fn buffer_readln(&self, buffer: &glib::ByteArray) {
        unsafe {
            ffi::g_mime_stream_buffer_readln(self.as_ref().to_glib_none().0, buffer.to_glib_none().0);
        }
    }

    fn close(&self) -> i32 {
        unsafe {
            ffi::g_mime_stream_close(self.as_ref().to_glib_none().0)
        }
    }
    ...
    fn eos(&self) -> bool {
        unsafe {
            from_glib(ffi::g_mime_stream_eos(self.as_ref().to_glib_none().0))
        }
    }

    fn flush(&self) -> i32 {
        unsafe {
            ffi::g_mime_stream_flush(self.as_ref().to_glib_none().0)
        }
    }

    fn length(&self) -> i64 {
        unsafe {
            ffi::g_mime_stream_length(self.as_ref().to_glib_none().0)
        }
    }
    ...
    fn reset(&self) -> i32 {
        unsafe {
            ffi::g_mime_stream_reset(self.as_ref().to_glib_none().0)
        }
    }
    ...
    fn substream(&self, start: i64, end: i64) -> Option<Stream> {
        unsafe {
            from_glib_full(ffi::g_mime_stream_substream(self.as_ref().to_glib_none().0, start, end))
        }
    }

    fn tell(&self) -> i64 {
        unsafe {
            ffi::g_mime_stream_tell(self.as_ref().to_glib_none().0)
        }
    }
    ...
    fn write_to_stream(&self, dest: &impl IsA<Stream>) -> i64 {
        unsafe {
            ffi::g_mime_stream_write_to_stream(self.as_ref().to_glib_none().0, dest.as_ref().to_glib_none().0)
        }
    }
