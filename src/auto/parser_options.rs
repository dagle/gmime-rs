...
use crate::{ParserWarning,RfcComplianceMode};
use glib::{translate::*};
...
glib::wrapper! {
    ...
    match fn {
        copy => |ptr| ffi::g_mime_parser_options_copy(mut_override(ptr)),
        free => |ptr| ffi::g_mime_parser_options_free(ptr),
...
#[must_use]
    ...
    pub fn set_address_compliance_mode(&mut self, mode: RfcComplianceMode) {
        unsafe {
            ffi::g_mime_parser_options_set_address_compliance_mode(self.to_glib_none_mut().0, mode.into_glib());
        }
    }
    ...
    pub fn set_allow_addresses_without_domain(&mut self, allow: bool) {
        unsafe {
            ffi::g_mime_parser_options_set_allow_addresses_without_domain(self.to_glib_none_mut().0, allow.into_glib());
        }
    }
    ...
    pub fn set_parameter_compliance_mode(&mut self, mode: RfcComplianceMode) {
        unsafe {
            ffi::g_mime_parser_options_set_parameter_compliance_mode(self.to_glib_none_mut().0, mode.into_glib());
        }
    }
    ...
    pub fn set_rfc2047_compliance_mode(&mut self, mode: RfcComplianceMode) {
        unsafe {
            ffi::g_mime_parser_options_set_rfc2047_compliance_mode(self.to_glib_none_mut().0, mode.into_glib());
        }
    }

    #[doc(alias = "g_mime_parser_options_set_warning_callback")]
    pub fn set_warning_callback<P: Fn(i64, ParserWarning, &str) + 'static>(&mut self, warning_cb: P) {
        let warning_cb_data: Box_<P> = Box_::new(warning_cb);
        unsafe extern "C" fn warning_cb_func<P: Fn(i64, ParserWarning, &str) + 'static>(offset: i64, errcode: ffi::GMimeParserWarning, item: *const libc::c_char, user_data: glib::ffi::gpointer) {
        ...
        unsafe extern "C" fn notify_func<P: Fn(i64, ParserWarning, &str) + 'static>(data: glib::ffi::gpointer) {
            let _callback: Box_<P> = Box_::from_raw(data as *mut _);
        }
        let destroy_call3 = Some(notify_func::<P> as _);
        let super_callback0: Box_<P> = warning_cb_data;
        unsafe {
            ffi::g_mime_parser_options_set_warning_callback(self.to_glib_none_mut().0, warning_cb, Box_::into_raw(super_callback0) as *mut _, destroy_call3);
        }
    }

    #[doc(alias = "g_mime_parser_options_get_default")]
    #[doc(alias = "get_default")]
    #[allow(clippy::should_implement_trait)]    pub fn default() -> Option<ParserOptions> {
        assert_initialized_main_thread!();
        unsafe {
