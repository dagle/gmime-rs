...
#[must_use]
    ...
    pub fn create_newline_filter(&mut self, ensure_newline: bool) -> Option<Filter> {
        unsafe {
            from_glib_full(ffi::g_mime_format_options_create_newline_filter(self.to_glib_none_mut().0, ensure_newline.into_glib()))
        }
    }
    ...
    pub fn set_newline_format(&mut self, newline: NewLineFormat) {
        unsafe {
            ffi::g_mime_format_options_set_newline_format(self.to_glib_none_mut().0, newline.into_glib());
        }
    }
    ...
    pub fn set_param_encoding_method(&mut self, method: ParamEncodingMethod) {
        unsafe {
            ffi::g_mime_format_options_set_param_encoding_method(self.to_glib_none_mut().0, method.into_glib());
        }
    }

    #[doc(alias = "g_mime_format_options_get_default")]
    #[doc(alias = "get_default")]
    #[allow(clippy::should_implement_trait)]    pub fn default() -> Option<FormatOptions> {
        assert_initialized_main_thread!();
        unsafe {
