...
const RUST_CONSTANTS: &[(&str, &str)] = &[
    ...
    ("(gint) GMIME_CRIT_CONFLICTING_HEADER", "10"),
    ("(gint) GMIME_CRIT_CONFLICTING_PARAMETER", "11"),
    ("(gint) GMIME_CRIT_INVALID_HEADER_NAME", "9"),
    ("(gint) GMIME_CRIT_MULTIPART_WITHOUT_BOUNDARY", "12"),
    ("(gint) GMIME_CRIT_NESTING_OVERFLOW", "15"),
    ("(gint) GMIME_CRIT_PART_WITHOUT_HEADERS_OR_CONTENT", "17"),
    ("(guint) GMIME_DECRYPT_ENABLE_KEYSERVER_LOOKUPS", "32768"),
    ("(guint) GMIME_DECRYPT_ENABLE_ONLINE_CERTIFICATE_CHECKS", "32768"),
    ("(guint) GMIME_DECRYPT_EXPORT_SESSION_KEY", "1"),
    ("(guint) GMIME_DECRYPT_NONE", "0"),
    ("(guint) GMIME_DECRYPT_NO_VERIFY", "2"),
    ...
    ("(guint) GMIME_ENCRYPT_ALWAYS_TRUST", "1"),
    ("(guint) GMIME_ENCRYPT_NONE", "0"),
    ("(guint) GMIME_ENCRYPT_NO_COMPRESS", "16"),
    ("(guint) GMIME_ENCRYPT_SYMMETRIC", "32"),
    ("(guint) GMIME_ENCRYPT_THROW_KEYIDS", "64"),
    ...
    ("GMIME_SIGNATURE_STATUS_ERROR_MASK", "-8"),
    ...
    ("(guint) GMIME_VERIFY_ENABLE_KEYSERVER_LOOKUPS", "32768"),
    ("(guint) GMIME_VERIFY_ENABLE_ONLINE_CERTIFICATE_CHECKS", "32768"),
    ("(guint) GMIME_VERIFY_NONE", "0"),
    ("(gint) GMIME_WARN_DUPLICATED_HEADER", "1"),
    ("(gint) GMIME_WARN_DUPLICATED_PARAMETER", "2"),
    ("(gint) GMIME_WARN_INVALID_ADDRESS_LIST", "14"),
    ("(gint) GMIME_WARN_INVALID_CONTENT_TYPE", "4"),
    ("(gint) GMIME_WARN_INVALID_PARAMETER", "13"),
    ("(gint) GMIME_WARN_INVALID_RFC2047_HEADER_VALUE", "5"),
    ("(gint) GMIME_WARN_MALFORMED_MESSAGE", "8"),
    ("(gint) GMIME_WARN_MALFORMED_MULTIPART", "6"),
    ("(gint) GMIME_WARN_PART_WITHOUT_CONTENT", "16"),
